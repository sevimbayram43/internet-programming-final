...
<head>
    ...
    <title id="title">Kategoriler</title>
...
<body>
    ...
    <div class="container my-3" id="cont">
        <div class="col-lg-4 text-center bg-light my-3" style="margin:auto;border-top: 2px groove black;border-bottom: 2px groove black;">     
            <h2 class="text-center"><span id="catTitle">Ürünler</span></h2>
        </div>
        <div class="row">
        <?php
            $id = $_GET['catid'];
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <h6 style="color: #ff0000">'.$pizzaPrice. ' TL</h6>
                                ...
                                if($loggedin){
                                    ...
                                    if($quaExistRows == 0) {
                                        ...
                                        echo '<a href="viewCart.php"><button class="btn btn-primary mx-2">Sepete Git</button></a>';
                                    }
                                }
                                else{
                                    echo '<button class="btn btn-primary mx-2" data-toggle="modal" data-target="#loginModal">Sepete Ekle</button>';
                                }
                            echo '</form>                            
                                <a href="viewPizza.php?pizzaid=' . $pizzaId . '" class="mx-2"></a> 
                                </div>
                            </div>
                        </div>
                    </div>';
