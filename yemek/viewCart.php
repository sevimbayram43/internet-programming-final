...
<body>
                    ...
                    <table class="table text-center">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">Ürün Fİyatı</th>
                                <th scope="col">Adet</th>
                                <th scope="col">Toplam Tutar</th>
                                <th scope="col">
                                    <form action="partials/_manageCart.php" method="POST">
                                        <button name="removeAllItem" class="btn btn-sm btn-outline-danger">Hepsini Sİl</button>
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <form action="partials/_manageCart.php" method="POST">
                                                    <button name="removeItem" class="btn btn-sm btn-outline-danger">Sil</button>
            ...
            <div class="col-lg-4">
                <div class="card wish-list mb-3">
                    <div class="pt-4 border bg-light rounded p-3">
                        <h5 class="mb-3 text-uppercase font-weight-bold text-center">Şipariş Özeti</h5>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 pb-0 bg-light">Toplam Tutar<span><?php echo $totalPrice ?> TL </span></li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0 bg-light">Kargo<span> Ücretsiz</span></li>
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3 bg-light">
                                <div>
                                    <strong>Tutar</strong>
                                  
                                </div>
                                <span><strong><?php echo $totalPrice ?>TL </strong></span>
                            </li>
                        </ul>
                    
                        <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#checkoutModal">Ödeme Yapın</button>
                    </div>
                </div>
                <div class="mb-3">
                    <div class="pt-4">
    ...
    <?php 
        ...
        <div class="alert alert-info my-3">
            <font style="font-size:22px"><center>Sepete Gitmek İçin Giriş Yapmanız Gerekmektedir</strong></center></font>
        </div></div>';
    }
    ?>
